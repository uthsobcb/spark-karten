            ...
            {user && (
                <>
                    ...
                    <div className='flex gap-4 m-8'>
                        <a href="/create"><div className={`max-w-full h-[300px] bg-white border border-gray-200 rounded-lg p-14 text-wrap`}>
                            <svg width='95' height='95' viewBox="-3.5 0 32 32" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill-rule="evenodd" clip-rule="evenodd" d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22ZM12.75 9C12.75 8.58579 12.4142 8.25 12 8.25C11.5858 8.25 11.25 8.58579 11.25 9L11.25 11.25H9C8.58579 11.25 8.25 11.5858 8.25 12C8.25 12.4142 8.58579 12.75 9 12.75H11.25V15C11.25 15.4142 11.5858 15.75 12 15.75C12.4142 15.75 12.75 15.4142 12.75 15L12.75 12.75H15C15.4142 12.75 15.75 12.4142 15.75 12C15.75 11.5858 15.4142 11.25 15 11.25H12.75V9Z" fill="#1C274C"></path> </g></svg>
                            <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900">Create Card</h5>
                        </div>
                        </a>
                        <a href="/card"> <div className={`max-w-full h-[300px] bg-white border border-gray-200 rounded-lg p-14 text-wrap`}>
